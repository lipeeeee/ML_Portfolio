...
This repository contains my journey to learning machine learning and a collection of machine learning projects that I have worked on as part of it. Each project is organized into its own folder and includes its own README.md file with a resume of the project and its findings.
<p>
